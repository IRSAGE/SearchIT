      ...
      .then(myJson => {
        ...
        for (const key in myJson) {
          const result = myJson[key];
           //comparing the search key with the results
          if (
        ...
        if (count == 0) {
          result_containner.innerHTML = `
              ...
              <p>Your search input - <b>${
                search.value
              }</b> - did not match any City or State in Us Cities or States <br> 
              you can check below in the suggestions to view how to search .</p>
              ...
              <li>Try different keywords regarding to what city or state you want.</li>
